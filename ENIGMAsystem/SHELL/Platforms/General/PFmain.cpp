...
int enigma_main(int argc, char** argv) {
  ...
  #endif
  enigma_user::directory_set_current_working(enigma_user::directory_get_current_working() + "assets");
  ...
  enigma_user::environment_set_variable("IMGUI_HEAD_COLOR_1", std::to_string(0.55));
  enigma_user::environment_set_variable("IMGUI_HEAD_COLOR_2", std::to_string(0.55));
  enigma_user::environment_set_variable("IMGUI_AREA_COLOR_0", std::to_string(0.18));
  enigma_user::environment_set_variable("IMGUI_AREA_COLOR_1", std::to_string(0.18));
  enigma_user::environment_set_variable("IMGUI_AREA_COLOR_2", std::to_string(0.18));
