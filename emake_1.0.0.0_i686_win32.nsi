...
!include "MUI2.nsh"
Unicode True
!define PRODUCT "emake"
Name "emake"
Outfile "C:\emake_1.0.0.0_i686_win32.exe"
...
!define MUI_ICON "C:\emake-Windows-i686\Resources\icon.ico"
...
Section "emake"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT}" "UninstallString" '"$INSTDIR\${PRODUCT}-Uninstaller-i686.exe"'
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT}" "NoModify" 1
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT}" "NoRepair" 1

  ;Create optional start menu shortcut for Uninstaller and Main component
  CreateDirectory "$SMPROGRAMS\${PRODUCT}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT}\emake (x86).lnk" "$INSTDIR\emake-Windows-i686\emake.exe"  0
  CreateShortCut "$SMPROGRAMS\${PRODUCT}\Uninstall emake (x86).lnk" "$INSTDIR\${PRODUCT}-Uninstaller-i686.exe" "" "$INSTDIR\${PRODUCT}-Uninstaller-i686.exe" 0
