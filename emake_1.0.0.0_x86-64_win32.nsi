...
Name "emake"
Outfile "C:\emake_1.0.0.0_x86-64_win32.exe"
...
!define MUI_ICON "C:\emake-Windows-x86_64\Resources\icon.ico"
...
Section "emake"
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT}\emake (x64).lnk" "$INSTDIR\emake-Windows-x86_64\emake.exe"  0
  CreateShortCut "$SMPROGRAMS\${PRODUCT}\Uninstall emake (x64).lnk" "$INSTDIR\${PRODUCT}-Uninstaller-x86_64.exe" "" "$INSTDIR\${PRODUCT}-Uninstaller-x86_64.exe" 0
